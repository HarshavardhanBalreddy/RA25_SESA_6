    ...
    <h4> Vehicle info</h4>
						...
						<div class="div-section dept-contacted">
							...
							<table>
								...
								if($H_name!='-'){
									...
									<th> 
										<div class="dep-detail">
											<center><p class="dep-detail-name">-</p></center>
										</div>
									</th>
									<td class="ll">
										<form method="POST" action="tranfpage.php"> 
										<div class="loc">
											<input type="text" name="DeviceID" id="dasb" value="'.$DeviceIDt." H ".$Timestamp_date." ".$Timestamp_time.'"/>
                    						<button name="transb" id="transb" id="hospital">Add</button>
                    						</div>
										</form>
									</td>
								</tr>';
								...
								if($P_name!='-'){
									...
									<td class="ll">
										<form method="POST" action="tranfpage.php"> 
										<div class="loc">
											<input type="text" name="DeviceID" id="dasb" value="'.$DeviceIDt." P ".$Timestamp_date." ".$Timestamp_time.'"/>
                    						<button name="transb" id="transb" id="police">Add</button>
                    						</div>
										</form>
									</td>
								</tr>';
								...
								if($F_name!='-'){
									...
									<td class="ll">
										<form method="POST" action="tranfpage.php"> 
										<div class="loc">
											<input type="text" name="DeviceID" id="dasb" value="'.$DeviceIDt." F ".$Timestamp_date." ".$Timestamp_time.'"/>
                    						<button name="transb" id="transb" id="fire station">Add</button>
                    						</div>
										</form>
									</td>
								</tr>';
					...
					<div class="locate-area">
						...
						<div class="div-section-loc but">
							...
							<input type="text" name="DeviceID" value="'.$DeviceIDw.'"/>
							<button class="loc-button" id="location">Locate</button>
							</form>
						</div>
					</div>
					<div class="pic-area">';
					if (file_exists($DeviceID.' '.$Timestamp.'.png')==1) {
						$content = $content.'<img src="'.$DeviceID.' '.$Timestamp.'.png"/>';
					}
					else
					{
						$content = $content.'<img src="imgsam.png"/>';
					}
					$content = $content.'	
					<div>
